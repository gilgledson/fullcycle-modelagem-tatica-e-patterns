...
import Address from "../../customer/object-value/address";
...
import SendEmailWhenProductCreatedEventHandler from "../../product/event/handler/send-email-when-product-is-created.handler";
